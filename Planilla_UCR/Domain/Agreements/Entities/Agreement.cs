...
namespace Domain.Agreements.Entities
{
    public class Agreement
    {
        ...
        public Agreement(string employeeEmail, string employerEmail, string projectName, DateTime contractStartDate, string contractType, string mountPerHour, DateTime contractFinishDate)
        {
