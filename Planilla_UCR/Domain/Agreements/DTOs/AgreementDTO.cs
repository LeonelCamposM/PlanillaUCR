...
namespace Domain.Agreements.DTOs
{
    public class AgreementDTO
    {
        ...
        public AgreementDTO(string employeeEmail, string employerEmail, string projectName, string contractStartDate, string contractType, int mountPerHour, string contractFinishDate)
        {
